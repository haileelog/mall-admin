		...
		<!-- 관리자 회원메뉴 -->
			...
			<ul>					
				...
				<c:if test="${loginMember != null }">
					...
					<br>
					<li><a href="/member/mypage?memberNo=${loginMember.memberNo}">마이페이지</a></li><br>
					<li><a href="/category/addCategory">카테고리 추가</a></li>
					<li><a href="/product/productCommonList">상품목록</a></li>
